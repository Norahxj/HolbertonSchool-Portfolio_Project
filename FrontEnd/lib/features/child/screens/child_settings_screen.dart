...
class _ChildSettingsScreenState extends State<ChildSettingsScreen> {
    ...
    final shouldLogout = await showDialog<bool>(
      ...
      builder: (dialogContext) {
        return Directionality(
          ...
          child: AlertDialog(
            title: Text(_isArabic ? 'تسجيل الخروج' : 'Log out'),
            content: Text(
              _isArabic
  ...
  Widget build(BuildContext context) {
    ...
    final accountLabel = _isArabic ? 'حساب الطفل' : 'Child account';
    final languageLabel = _isArabic ? 'اللغة' : 'Language';
    final currentLanguage = _isArabic ? 'العربية' : 'English';
    final changeLanguageLabel = _isArabic
          ...
          child: ListView(
            ...
            children: [
              Container(
                ...
                child: Row(
                  children: [
                    ChildAvatar(avatarIndex: widget.avatarIndex, size: 56),
                ...
                child: Column(
                  children: [
                    ListTile(
                      ...
                      subtitle: Text('$currentLanguage · $changeLanguageLabel'),
                      trailing: const Icon(
