...
class _RewardManagementScreenState extends State<RewardManagementScreen> {
  ...
  Future<void> _deleteReward(RewardModel reward) async {
    ...
    try {
      ...
      setState(() {
        final safeIndex = rewardIndex.clamp(0, currentRewards.length);
        ...
        children: [
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    isArabic
                        ? 'ينالها طفلك يوم ${reward.unlockDayLabel}'
                        : 'Your child receives it on ${reward.unlockDayLabel}',
                    textAlign: TextAlign.center,
                    textDirection: isArabic
                        ? TextDirection.rtl
                        : TextDirection.ltr,
          ...
          SizedBox(
            ...
            child: onDelete == null
                ...
                : Center(
                    child: IconButton(
                      tooltip: isArabic ? 'حذف المكافأة' : 'Delete reward',
