...
class AppTextStyles {
  static TextStyle get logo => GoogleFonts.baloo2(
        fontSize: 34,
        fontWeight: FontWeight.w700,
        color: AppColors.primaryDark,
      );

  static TextStyle get logoArabic => GoogleFonts.balooBhaijaan2(
        fontSize: 42,
  ...
  // A slightly more playful heading for child-facing screens.
  static TextStyle get childTitle => GoogleFonts.balooBhaijaan2(
        fontSize: 27,
        fontWeight: FontWeight.w700,
        color: AppColors.textPrimary,
      );
