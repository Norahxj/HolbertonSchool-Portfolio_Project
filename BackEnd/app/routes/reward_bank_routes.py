...
api = Namespace(
    "reward-bank",
    description="Suggested reward bank operations"
)
...
class RandomSuggestedRewardsResource(Resource):
    ...
    @api.response(
        200,
        "Reward suggestions returned successfully"
    )
    def post(self):
        ...
        suggestions, service_error = (
            reward_bank_service.get_random_suggestions(
