...
from app.routes.task_assignment_routes import (
    api as task_assignment_ns,
)
from app.routes.points_routes import api as point_ns
from app.routes.points_history_routes import (
    api as points_history_ns,
)
from app.routes.reward_routes import api as reward_ns
from app.routes.daily_feedback_routes import (
    api as daily_feedback_ns,
)
...
from app.routes.weekly_plan_routes import api as weekly_plan_ns
...
def create_app(test_config=None):
    ...
    CORS(
        ...
        resources={
            r"/api/*": {
                "origins": "https://asalah-26b7d.web.app"
            }
        },
    ...
    def check_if_token_revoked(jwt_header, jwt_payload):
        ...
        token = RevokedToken.query.filter_by(
            jti=jti
        ).first()
